...
import StudentShowCourseComponent from './StudentShowCourseComponent';
import StudentUserCartComponent from './StudentUserCartComponent';
import './Students.css';
...
'https://www.nextskills360.in/wp-content/uploads/2022/04/Coding-Toy1.png'
    ...
    return (
        <div className="App">
            <StudentSearchComponent searchCourse={searchCourse} 
                             courseSearchUserFunction=
                                 {courseSearchUserFunction} />
            <main className="App-main">
                <StudentShowCourseComponent
                    courses={products}
                    filterCourseFunction={filterCourseFunction}
                    addCourseToCartFunction={addCourseToCartFunction}
                />
 
                <StudentUserCartComponent
