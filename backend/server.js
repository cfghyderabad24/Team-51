...
.then(client=>{
    ...
    const announcementCollection=NextSkills.collection('announcementcollection')
    const userCollection=NextSkills.collection('usercollection')
...
const newsApp=require('./APIs/newsApi')
